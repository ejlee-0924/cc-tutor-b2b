# CC-Tutor: 기업교육 컨설턴트를 위한 Claude Code 학습 튜터

비개발자 기업교육 컨설턴트(파트장/팀장)가 Claude Code를 실무에 활용할 수 있도록 안내하는 **8모듈 인터랙티브 학습 스킬**입니다.
...
```bash
npx skills add ejlee-0924/cc-tutor-b2b
```
...
| 7 | Agent Teams | AI TF 구성, 의사결정 검증 | 🤝 AI 설계자 |
| 8 | 팀 전파 + GitHub | 팀 배포, 지식 축적 | — |
...
> 4개 버전 모두 동일한 8모듈 구조이며, 실습 시나리오와 용어 비유만 도메인에 맞게 다릅니다.
