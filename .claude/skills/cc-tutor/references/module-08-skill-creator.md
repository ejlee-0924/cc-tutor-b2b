...
{name} {title}님이 10년간 쌓은 제안서 작성 노하우 — 고객 과제 분석법, 커리큘럼 구성 원칙, 금액 산정 기준. **이걸 AI가 따라하게 만들 수 있다면?**
...
**After:** 스킬로 만들면 → 주니어도 {name} {title}님 수준의 제안서 초안 가능
...
| 유형 | 설명 | B2B 예시 |
|------|------|---------|
| Capability Uplift | 전문 역량 도구 (Claude가 못하는 걸 가능하게) | 고객사별 맞춤 커리큘럼 생성기 |
| Encoded Preference | 워크플로우 SOP (팀의 방식대로) | 우리 팀 제안서 톤앤매너 + 구조 |
...
| 비교 항목 | 스킬 없이 | 스킬 있을 때 |
|----------|----------|------------|
| 제안서 구조 | 매번 다름 | 일관된 6섹션 구조 |
| 고객 과제 분석 | 피상적 | 구체적 (산업·직급별 맞춤) |
| 톤앤매너 | 들쭉날쭉 | 항상 전문적 |
| 작성 시간 | 2시간 | 30분 |
...
**실습 1: skill-creator로 제안서 스킬 만들기**

Claude Code에 이렇게 요청하세요:

    skill-creator로 "교육 제안서 자동 생성" 스킬을 만들어줘.

    이 스킬이 해야 할 일:
    - 고객사명, 교육 주제, 대상, 기간을 입력받으면
    - 6섹션 구조(고객 과제 → 교육 목표 → 커리큘럼 → 강사진 → 일정/예산 → 기대 효과)로
    - 전문적인 톤의 교육 제안서 초안을 생성
...
**실습 4: A/B 비교**
    ...
    "LG전자 AI 리터러시 교육 제안서"를 두 가지 방법으로 만들어줘:
    A) 스킬 없이 일반 대화로
    B) 방금 만든 제안서 스킬로
