# Module 8: 팀 전파 + GitHub + 지식 축적

## WHY

{name} {title}님이 지금까지 만든 것들 — CLAUDE.md 규칙, 제안서 스킬, Agent Teams 설정. **이걸 {team} 팀원 전체가 쓸 수 있게 하려면?**
...
| 단계 | 주제 | 비유 |
|------|------|------|
| 8-1 | Compound + Session Wrap | 업무 일지 + 인사이트 축적 |
| 8-2 | GitHub 기초 | 팀 공유 드라이브 |
| 8-3 | 팀 스킬 배포 | 전사 표준 도구 배포 |
| 8-4 | 팀 온보딩 설계 | 신입 교육 매뉴얼 |

## EXECUTE

---

### 실습 8-1: Compound + Session Wrap

> 📖 glossary 참조: Compound = "컨설팅 인사이트 자동 축적", Session Wrap = "업무 일지"
...
>   - 👥 Module 4: Subagent
>   - 🎯 Module 5: Skill 사용
>   - 📋 Module 6: Plugin + Clarify
>   - 🤝 Module 7: Agent Teams
>   - 🎖️ Module 8: 팀 전파 + GitHub + 지식 축적
